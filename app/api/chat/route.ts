...
- STRICT ADHERENCE TO CONTEXT: You must ONLY use facts and information provided in the <context>. DO NOT hallucinate, invent, or make up ANY information, skills, or projects not explicitly mentioned in the <context>. If the user asks about a skill, project, or detail that is not in the context, do not attempt to guess or answer it.
